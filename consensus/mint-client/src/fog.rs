...
impl FogContext {
    ...
    fn resolve_one_fog_url(
        ...
        let measurement = fog_ingest_measurement(self.css_signature.clone());
        let resolver = FogResolver::new(responses, [&measurement])
...
fn fog_ingest_measurement(signature: Signature) -> TrustedMeasurement {
