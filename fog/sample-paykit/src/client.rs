...
pub struct Client {
    ...
    fog_measurements: Vec<TrustedMeasurement>,
...
impl Client {
    ...
    pub fn new(
        ...
        fog_block: FogBlockGrpcClient,
        fog_report_conn: GrpcFogReportConnection,
        fog_measurements: impl Into<Vec<TrustedMeasurement>>,
        fog_untrusted: FogUntrustedLedgerGrpcClient,
        ring_size: usize,
        account_key: AccountKey,
        ...
        Client {
            ...
            fog_block,
            fog_report_conn,
            fog_measurements: fog_measurements.into(),
            fog_untrusted,
            ring_size,
            account_key,
            tx_data,
    ...
    pub fn build_transaction<T: RngCore + CryptoRng>(
        ...
        let fog_resolver = FogResolver::new(fog_responses, &self.fog_measurements)?;
